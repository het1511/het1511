...
- 🎯 Goal: Land my first Backend Developer job
...
|--------|-------------|------------|
| 📝 [To-Do REST API](#) | A full CRUD REST API for managing tasks | Java, Spring Boot, H2 |
| 🔐 [User Auth System](#) | Register/Login with JWT Authentication | Spring Boot, Spring Security, MySQL |
...
✅ Java Fundamentals
✅ OOP Concepts
🔄 Spring Boot Basics       ← Currently Here
⏳ Spring Security + JWT
